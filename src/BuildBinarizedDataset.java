...
public class BuildBinarizedDataset {
   ...
   * separated by blank lines. The first line has the buildTrainData label of the sentence together with the full sentence.
   ...
   * tokens the label applies to. All phrases that do not have their own label will take on the buildTrainData sentence label!
   *  For example:
   * <br>
   * <code>
